...
--
-- Servidor: localhost
-- Tiempo de generación: 05-03-2019 a las 03:23:52
...
(6, 6, '99px', '100px', '53px', '450.698px', 'http://localhost/levantamientorequisitos/iconos/circulo.png'),
(7, 6, '99px', '100px', '267px', '276.698px', 'http://localhost/levantamientorequisitos/iconos/cuadrado.png'),
(8, 7, '99px', '100px', '173px', '440.698px', 'http://localhost/levantamientorequisitos/iconos/triangulo.png'),
(9, 7, '99px', '100px', '6px', '146px', 'http://localhost/levantamientorequisitos/iconos/circulo.png');
...
CREATE TABLE `rol_negocio` (
  ...
  `nombre_rol_negocio` varchar(18) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `descripcion_rol_negocio` varchar(50) CHARACTER SET utf16 COLLATE utf16_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
--
ALTER TABLE `rol_negocio`
  MODIFY `id_rol_negocio` int(11) NOT NULL AUTO_INCREMENT;
