    ...
    */ 
    function registrarRol() {
      ...
      $descripcion = $_REQUEST['descrip'];
        ...
        {
                        echo '<script type="text/javascript"> location.href = "http://localhost/levantamientorequisitos/IconController"; 
                 alert (" Fallo");
                 </script>';
        }
...
//////////////
 ...
 $btnView = "<button class='btn btn-primary btn-sm' onclick='verRol($id_icono);'><span class='glyphicon glyphicon-search'></span></button>";
                $btnEdit = "<button class='btn btn-warning btn-sm' onclick='actualizarRol($id_icono);'><span class='glyphicon glyphicon-pencil'></span></button>";
