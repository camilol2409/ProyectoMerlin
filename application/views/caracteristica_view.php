...
<div id="info_caracteristica">
    ...
    <table class="table ">
            ...
            <form action="CaracteristicaController">
                <button type="submit"  class="form-control btn btn-primary" id="btnPreguntas"><span class="glyphicon glyphicon-question-sign"></span> Características y preguntas</button>
            </form>
                </td>
                <td>
                    <form action="IconController">
                <button type="submit"  class="form-control btn-info" id="btnIconos"><span class="glyphicon glyphicon-picture"></span> Iconos</button>
            </form>
                </td>
                <td>
